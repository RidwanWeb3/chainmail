        ...
        <Reveal className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-xl text-base text-muted-foreground">
              CHAINMAIL is designed to bring verifiable communication infrastructure
              into the Arc ecosystem.
            </p>
            <p className="mt-4 max-w-xl text-sm text-muted-foreground">
              Network parameters are configuration-driven and verified before
              deployment. Legacy Ethereum/Goerli values from the original repository
              are treated as historical reference only.
            </p>
